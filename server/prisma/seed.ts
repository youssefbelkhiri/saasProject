...
async function main() {
  ...
  //       },
  //       groups: {
  //         connect: [{ group_id: group1.group_id }, { group_id: group2.group_id }],
  //       },
  //     },
  //   });
  ...
  for (let i = 0; i < 20; i++) {
    await prisma.papers.create({
      data: {
        paper: faker.lorem.words(),
        note: getRandomNumber(1, 20),
        exam_id: getRandomNumber(1, 2),
        student_id: i + 1,
      },
    });
  }
  // for (let i = 0; i < 20; i++) {
  //   await prisma.student_group.create({
  //     data: {
  //       group_id: getRandomNumber(1, 2), // Adjust as needed
  //       student_id: i + 1, // Adjust as needed
  //     },
  //   });
  // }
}
